    ...
    <div className="flex min-w-0 flex-1">
      <main className="min-w-0 flex-1 px-5 py-8 sm:px-8 lg:px-12">
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 h-1.5 w-36 rounded-full bg-gradient-to-r from-amber-600 via-amber-400 to-amber-200 dark:from-amber-400 dark:via-amber-500 dark:to-amber-900" />
        </div>
        ...
        <footer className="mt-10 pb-4 text-xs leading-relaxed text-zinc-400">
          本站為《子彈思考整理術》(瑞德・卡洛 Ryder Carroll 著,天下雜誌出版)的教學導讀筆記,內容為重點整理與延伸解說,並非原書全文。完整內容請支持正版書籍。
        </footer>
      </main>
