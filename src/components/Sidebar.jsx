...
function PartGroup({ part, onNavigate }) {
  ...
  return (
    <div className="mt-4">
      ...
      {open && (
        <div className="mt-1 space-y-0.5 border-l border-amber-300/60 pl-2 dark:border-amber-800/50">
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        `block rounded-lg px-2.5 py-1.5 text-[13.5px] leading-snug transition-colors ${
          isActive
            ? "bg-amber-500/15 font-semibold text-amber-800 dark:bg-amber-400/15 dark:text-amber-300"
